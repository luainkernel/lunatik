...
return {
	...
	{ header = "net/dropreason-core.h",         prefix = "SKB_DROP_REASON_", module = "dropreason",
		desc = "Socket buffer (skb) drop reasons." },
	{ header = "net/dropreason-core.h",         prefix = "SKB_",       module = "dropreason",
		desc = "Unprefixed skb_drop_reason sentinels.",
