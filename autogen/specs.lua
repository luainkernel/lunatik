...
return {
	...
	{ header = "uapi/linux/nl80211.h", prefix = "NL80211_ATTR_", module = "nl80211.attr",
		...
		include = { "WIPHY", "WIPHY_NAME", "WIPHY_FREQ", "IFINDEX", "IFNAME", "IFTYPE", "MAC",
			...
			"KEY_DATA", "KEY_IDX", "KEY_CIPHER", "KEY_SEQ",
	...
	{ header = "linux/ieee80211.h", prefix = "WLAN_CIPHER_SUITE_", module = "nl80211.cipher",
		desc = "802.11 cipher suites (WLAN_CIPHER_SUITE_*), for KEY_CIPHER.",
		include = { "CCMP", "CCMP_256", "GCMP", "GCMP_256", "TKIP" } },
