...
return {
	...
	{ header = "uapi/linux/netfilter/nf_conntrack_common.h", prefix = "IPS_",   module = "nf.ct.status",
		desc = "Conntrack status flags.",
		include = { "EXPECTED", "SEEN_REPLY", "ASSURED", "CONFIRMED", "SRC_NAT", "DST_NAT",
			"SEQ_ADJUST", "SRC_NAT_DONE", "DST_NAT_DONE", "DYING", "FIXED_TIMEOUT",
			"TEMPLATE", "UNTRACKED", "HELPER", "OFFLOAD", "HW_OFFLOAD" } },
	{ header = "uapi/linux/netfilter/nf_conntrack_common.h", prefix = "IPCT_",  module = "nf.ct.event",
		desc = "Conntrack event bit positions; the kernel reports them as a mask of `1 << value`." },
	...
	{ header = "uapi/linux/netfilter/nf_conntrack_tcp.h", prefix = "TCP_CONNTRACK_", module = "nf.ct.tcp",
		desc = "TCP conntrack states.",
		exclude = { "TCP_CONNTRACK_MAX", "TCP_CONNTRACK_TIMEOUT_MAX" } },
	{ header = "uapi/linux/netfilter/nf_nat.h", prefix = "NF_NAT_RANGE_", module = "nf.nat.range",
		desc = "NAT range flags.",
		include = { "MAP_IPS", "PROTO_SPECIFIED", "PROTO_RANDOM", "PERSISTENT",
			"PROTO_RANDOM_FULLY", "PROTO_OFFSET", "NETMAP" } },
	{ header = "net/netfilter/nf_nat.h",        prefix = "NF_NAT_MANIP_", module = "nf.nat.manip",
		desc = "NAT manipulation type (SRC/DST)." },
