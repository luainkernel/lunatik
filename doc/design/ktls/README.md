...
2. **This is incremental, and it is written from scratch.** `socket:setsockopt` is on `master`;
   nothing else here exists anywhere in the repository. Each phase is a shippable pull request:
