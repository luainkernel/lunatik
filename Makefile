...
LUNATIK_MODULES := DEVICE LINUX NOTIFIER SOCKET RCU THREAD FIB DATA PROBE SYSCALL XDP TC FIFO XTABLE NETFILTER \
...
ebpf_install:
	...
	${INSTALL} -m 0644 examples/filter/https_tc.o ${LUNATIK_EBPF_INSTALL_PATH}/
