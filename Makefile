...
LUNATIK_MODULES := DEVICE LINUX NOTIFIER SOCKET NETLINK RCU SET TASK THREAD FIB DATA PROBE SYSCALL XDP FIFO \
	SKB TC NETFILTER COMPLETION CRYPTO CPU HID SIGNAL BYTEORDER DARKEN SCHED EBPF_MAP
...
ebpf_install:
	...
	${INSTALL} -m 0644 examples/ema/scheduler.o ${LUNATIK_EBPF_INSTALL_PATH}/
