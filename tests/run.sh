...
run_suite "$DIR/signal/run.sh"
run_suite "$DIR/runtime/run.sh"
run_suite "$DIR/socket/run.sh"
run_suite "$DIR/netlink/run.sh"
run_suite "$DIR/skb/run.sh"
run_suite "$DIR/rcu/run.sh"
run_suite "$DIR/set/run.sh"
run_suite "$DIR/data/run.sh"
run_suite "$DIR/device/run.sh"
run_suite "$DIR/control/run.sh"
run_suite "$DIR/cli/run.sh"
run_suite "$DIR/fifo/run.sh"
run_suite "$DIR/struct/run.sh"
run_suite "$DIR/bpf/run.sh"
run_suite "$DIR/xdp/run.sh"
run_suite "$DIR/tc/run.sh"
run_suite "$DIR/sched/run.sh"
run_suite "$DIR/crypto/run.sh"
run_suite "$DIR/io/run.sh"
run_suite "$DIR/linux/run.sh"
run_suite "$DIR/lua/run.sh"
