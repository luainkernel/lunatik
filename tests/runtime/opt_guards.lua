...
--
-- Tests for lunatik_opt_t guards:
--   - SINGLE objects are rejected by resume() and _ENV
--   - NONE/MONITOR objects are accepted by resume() and _ENV
--   - data.new() mode parameter validation
