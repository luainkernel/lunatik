...
local run_test = require("tests").run_test

run_test("crypto_shash.new and digestsize", function()
...
run_test("crypto_shash:digest (single-shot)", function()
	local hasher = shash.new("sha256")
...
run_test("crypto_shash:init, update, final (multi-part)", function()
	local hasher = shash.new("sha256")
...
run_test("crypto_shash:finup", function()
	local hasher = shash.new("sha256")
	local data1 = "The quick brown "
...
run_test("crypto_shash:export and import functionality", function()
