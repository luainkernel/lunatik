...
run_test("HKDF test vectors from RFC 5869, Appendix A", function()
	local h = new"sha256"
...
run_test("HKDF-Expand-Label examples from https://quic.xargs.org/#client-initial-keys-calc", function()
	local h = new"sha256"
