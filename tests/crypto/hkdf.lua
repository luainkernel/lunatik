local h = require("hkdf")("sha256")
local hkdf, extract, tls13_expand_label = h.hkdf, h.extract, h.tls13_expand_label
...
xpcall(
  function ()
		print"Test vectors from RFC 5869, Appendix A"
		...
		expected = hex2bin"47c6a638d4968595cc20b7c8bc5fbfbfd02d7c17cc67fa548c043ecb547b0eaa"
