...
# ones the kernel could not use: a positive return is a WARN_ON_ONCE and EINVAL
# in do_dentry_open and a fake byte count in vfs_read, a value below -MAX_ERRNO
# is a pointer IS_ERR does not recognise, and a string arrives as no number at
