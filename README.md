...
Lunatik 4.3  Copyright (C) 2023-2026 Ring Zero Desenvolvimento de Software LTDA.
...
| `set` | Compact immutable string set with exact and suffix/prefix matching |
