...
/* shared with the host compiler (bin/lunatikc): the number configuration shapes the bytecode */
...
#ifdef __KERNEL__ /* _KERNEL, the fork's dialect switch, is set on the host build too */
